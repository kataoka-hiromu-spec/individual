public class JudgeExtended {
    private RandomJankenPlayer player1, player2, player3;

    public JudgeExtended(RandomJankenPlayer player1, RandomJankenPlayer player2, RandomJankenPlayer player3){
    ...
    public static void main(String[] args) {
        try {
            ...
            RandomJankenPlayer player2 = new JankenPlayerTypeB("Suzuki");
